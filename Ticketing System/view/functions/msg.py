class Message:
    ...
    move_not = "SYSTEM: Progress not changed." 
    ...
    move_todo = "SYSTEM: Set to To Do."
    move_inprogress = "SYSTEM: Set to In Progress."
    move_forchecking = "SYSTEM: Set to For Checking."
    move_done = "SYSTEM: Set to Done."